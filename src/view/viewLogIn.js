        ...
        <div class="row-login">
          ...
          <div class="column-login">
              ...
              <form id="login-user">
                  ...
                  <input class="d-block input-w" type="password" id="password-login" placeholder="Password" autocomplete>
                  <button class="d-block btn-login btn-width" id="login-btn">Log in</button>
                  <p class="m-auto white-bold-text">O bien ingresa con...</p>
                  <a id="fbBtn"><img class="social-btn" src="../images/facebook-logo-in-circular-button-outlined-social-symbol.svg" alt="Facebook"></img></a>
                  <a id="googleBtn"><img class="social-btn" src="../images/search.svg" alt="Google"></img></a>
              </form>
